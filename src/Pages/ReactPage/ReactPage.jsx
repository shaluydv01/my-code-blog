    ...
    <>
      ...
      <div id="react-body">
        <div id="reactpara-1">
          ...
          <SyntaxHighlighter language="javascript" style={atomOneDark} id="reactPara1-syn">
               {belowpara2}
           </SyntaxHighlighter>
        </div>
        <div id="notePara1">
          <p><strong>Note:</strong>{note1.notePara1}</p>
          <SyntaxHighlighter id="reactPara1-syn">npm install react-syntax-highlighter@latest</SyntaxHighlighter>
          <p>To use this in your code export it like:</p>
          <SyntaxHighlighter id="reactPara1-syn">{inNotepara1}</SyntaxHighlighter>
        </div>
        <div id="reactPara2">
          <h4>{reactPara2.para1}</h4>
          <SyntaxHighlighter language="javascript" style={atomOneDark} id="reactPara1-syn">{inpara2}</SyntaxHighlighter>
        </div>
        <div id="reactPara3">
        ...
        <div id="reactPara4">
          ...
          <h4>Using props here: will click any one of buttons the all buttons get updated simultaneously. </h4>
          <div id="para4-syn">
            <SyntaxHighlighter language="javascript" style={atomOneDark} id="reactPara1-syn">{inpara4_1}</SyntaxHighlighter>
            <SyntaxHighlighter language="javascript" style={atomOneDark} id="reactPara1-syn">{inpara4_2}</SyntaxHighlighter>
          </div>
        </div>
      </div>
    </>
